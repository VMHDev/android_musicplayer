...
public class SongFolderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final String TAG = "SongFolderAdapter";
    public MultiClickAdapterListener mListener;


    public SongFolderAdapter(Context context, ArrayList<SongModel> listSong, MultiClickAdapterListener listener) {
